...
/// </summary>
public sealed class PlayerSendNetworkStateSystem : MoonTools.ECS.System
{
    ...
    public PlayerSendNetworkStateSystem(
        World world,
    ...
    public override void Update(TimeSpan delta)
    {
        ...
        //if (_stateSyncTimer <= 0)
        {
            foreach (var entity in _filter.Entities)
            {
                ...
                var message = Message.Create(MessageSendMode.Unreliable, ClientMessageType.State);
